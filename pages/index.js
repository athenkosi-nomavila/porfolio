        ...
        <section className="bg-gradient-to-b from-blue-300 text- to-cyan-500">
          <section>
            <nav className="py-10  flex justify-between dark:text-white">
              <div className="md:text-4xl lg:text-6xl sm:text-4xl flex justify-center gap-10 pl-5  py-2 text-gray-800 dark:text-white">
            ...
            <div className="text-center shadow-2xl p-10 py-20">
              ...
              <div className=" text-center mx-auto m-auto shadow-2xl rounded-full w-80 h-80 relative overflow-hidden mt-10 lg:h-fit lg:w-fit md:h-96 md:w-96">
                <Image src={athi} />
              </div>
            </div>
          </section>
